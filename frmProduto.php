...
<body>
  ...
  <main class="container">
    <div class="bg-light p-5 rounded">
      ...
      <form class="m-5 container" action="salvarProduto.php" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="preco" name="preco" value="<?php echo $produto['preco'];?>">
        </div>
